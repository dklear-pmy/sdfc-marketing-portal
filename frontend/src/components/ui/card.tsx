...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Real border + shadow rather than a 10%-opacity ring: a white card on
        // a near-white page needs an edge you can actually see. Matches the
        // talent platform's Card (border-border-subtle + shadow-sm).
