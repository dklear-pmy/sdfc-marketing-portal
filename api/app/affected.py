...
TRIGGER_LOGIC = {
    ...
    "welcome_shopify_260715": [
        ...
        "No ticket history on the fan-attributes link: ticket_seats_purchased = 0, has_season_plan = FALSE, matches_attended_lifetime = 0 (missing row passes)",
        "…and on EVERY Archtics account reachable from the email (Archtics email table, transfer destinations): excluded only if BOUGHT (a SOLD seat) or ATTENDED (a gate scan) — a received transfer alone does not exclude",
